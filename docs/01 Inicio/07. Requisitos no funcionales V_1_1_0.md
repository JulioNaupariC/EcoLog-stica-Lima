...
| RNF-010 | Mantenibilidad | **Fuente:** desarrollador. **Estímulo:** modifica una regla parametrizable. **Entorno:** mantenimiento. **Artefacto:** servicio de reglas. **Respuesta:** aplica cambio con pruebas. **Medida:** cobertura de pruebas unitarias del dominio ≥80% y pipeline ejecuta pruebas antes de integrar cambios. | Reporte de cobertura y CI. |
...
|---|---|---|---|
| 1.0.0 | 04/09/2026 | Línea base inicial. | Requisitos no funcionales de la fase de inicio. |
| 1.1.0 | 10/09/2026 | RNF-010 actualiza cobertura mínima de 70% a 80%. | Alinear mantenibilidad con el Definition of Done obligatorio de la Fase 02 y eliminar ambigüedad entre calidad de dominio y gate de entrega. |
